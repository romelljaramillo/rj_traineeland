...
class AdminRjInternshipProfessionController extends ModuleAdminController
{
    public $name = 'rj_internship_profession';
    ...
    public function __construct()
    {
        ...
        $this->lang = true;
        $this->actionsRow();
        $this->table = 'rj_internship_profession';
        ...
        $this->deleted = false;
        $this->identifier = 'id_internship_profession';
        $this->_defaultOrderBy = 'id_internship_profession';
